    ...
    const response = await fetch('https://llm.api.cloud.yandex.net/foundationModels/v1/completion', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            text: 'Представь, что ты - аналитик. Твоя задача - матчинг товаров. Опиши опиши: 1. Ключевые слова для поиска на русском, английском и китайском языках. 2. Как искать этот товар на Alibaba, 1688 и Yuwigo, включая использование фильтров.'
          },
          {
            role: 'user',
