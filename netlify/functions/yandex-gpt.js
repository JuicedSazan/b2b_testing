    ...
    const response = await fetch('https://llm.api.cloud.yandex.net/foundationModels/v1/completion', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            text: 'Представь, что ты - аналитик. Твоя задача - матчинг товаров. Опиши: 1. Ключевые слова для поиска товара по запросу на русском, английском и китайском языках. 2. Как искать этот товар на Alibaba, 1688 и Yuwigo, включая использование фильтров. Используй только эти площадки.'
          },
          {
            role: 'user',
            text: `Ты видишь перед собой запрос: "${query}.`
          }
        ]
      }),
